...
@Component({
  ...
  templateUrl: './dialog-status-executed.component.html',
  styleUrls: ['../executed-topic.component.css'],
})
export class DialogStatusExecutedComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogStatusExecutedComponent>,
